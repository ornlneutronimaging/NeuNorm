...
class TestLoading(unittest.TestCase):
    ...
    def test_loading_good_several_single_files(self):
        ...
        o_norm = Normalization()
        o_norm.load(
            file=sample_fits_file_1, data_type="sample", auto_gamma_filter=False
        )
        o_norm.load(
            file=sample_fits_file_2, data_type="sample", auto_gamma_filter=False
        )
